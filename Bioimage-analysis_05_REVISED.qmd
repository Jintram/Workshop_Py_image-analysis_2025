...
```{python}
_=plt.imshow(seg_bacterium(invert(imgs_ecoli[10,:,:])), cmap=cmap_random(500))
_=plt.imshow(seg_bacterium(invert(imgs_ecoli[100,:,:])), cmap=cmap_random(500))
_=plt.imshow(seg_bacterium(invert(imgs_ecoli[500,:,:])), cmap=cmap_random(500))
_=plt.imshow(seg_bacterium(invert(imgs_ecoli[1000,:,:])), cmap=cmap_random(500))
_=plt.imshow(seg_bacterium(invert(imgs_ecoli[1050,:,:])), cmap=cmap_random(500))
```
