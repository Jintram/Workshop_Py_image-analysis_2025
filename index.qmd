...
5. [Combining building blocks into a pipeline](Bioimage-analysis_05_Pipelines.qmd)
    - See also:
        - [Building blocks for bacteria exercise](Bioimage-analysis_05a_Pipelines_buildingblocks.qmd)
    - **Topics**
...
7. [Appendix, tools & remarks](Bioimage-analysis_07_Useful_tools.qmd)
    - **Topics**
        - List of tools that might be convenient

<!-- Removed, as its covered in other parts and previous course -->
