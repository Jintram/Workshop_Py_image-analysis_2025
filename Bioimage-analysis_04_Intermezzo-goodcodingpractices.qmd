...
To write code that can be read by others and future you [[1](https://github.com/Droogans/unmaintainable-code)]:

- Use descriptive names (for functions, parameters, etc)
- Add explanatory comments (re. purpose and strategy)
- Use consistent style (styleguides, see [[2](https://peps.python.org/pep-0008/)] and [[3](https://google.github.io/styleguide/pyguide.html)] )
- Write modular code
- Refactor regularly
- Make code easy to run, with reproducible outcome
    - (Reproducible randomness with seeds, track software versions, parameter settings and metadata -- don't end up with figures for which you don't know how they were made.)
- Use version tracking (git and [github](https://github.com/))

More advanced:

- Consider reproduction packages for publication
    - (Shareable bundle of your workflow including scripts, raw data and instructions, to go from raw data to final figures.)
- [Test](https://en.wikipedia.org/wiki/Unit_testing) function behavior
- Validate (function) input (avoid unexpected outcomes)
- Read a book about coding style, like ["Clean Code"](https://www.google.nl/books/edition/Clean_Code/hjEFCAAAQBAJ) by Robert C. Martin (ISBN 978-0132350884).
