...
For further reading, check out [lossless](https://en.wikipedia.org/wiki/Lossless_compression) and [lossy](https://en.wikipedia.org/wiki/Lossy_compression) compression at Wikipedia.

See [imageio](https://imageio.readthedocs.io/en/stable/formats/index.html)'s documentation
for a list of supported formats, and which libraries are preferentially used
to read files.