...
_ = axs[0].set_title("Text (changing absolute values)")
...
I WAS EDITING HERE; MAYBE MAKE LIST BELOW MORE CONCISE, AND FOCUSSED AROUND
DIFFERENT USE CASES
...
A few examples of cannonical thresholding algorithms and their output can be found at [scikit image's documentation](https://scikit-image.org/docs/0.23.x/auto_examples/segmentation/plot_thresholding.html).
